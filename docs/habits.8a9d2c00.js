 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class e${constructor(e){this.name=e,this.providers=new Map}addComponent(e){let t=this.getProvider(e.name);if(t.isComponentSet())throw Error(`Component ${e.name} has already been registered with ${this.name}`);t.setComponent(e)}addOrOverwriteComponent(e){this.getProvider(e.name).isComponentSet()&&this.providers.delete(e.name),this.addComponent(e)}getProvider(e){if(this.providers.has(e))return this.providers.get(e);let t=new ej(e,this);return this.providers.set(e,t),t}getProviders(){return Array.from(this.providers.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nq{constructor(e){this.nextCallback=null,this.catchCallback=null,this.result=void 0,this.error=void 0,this.isDone=!1,this.callbackAttached=!1,e(e=>{this.isDone=!0,this.result=e,this.nextCallback&&this.nextCallback(e)},e=>{this.isDone=!0,this.error=e,this.catchCallback&&this.catchCallback(e)})}catch(e){return this.next(void 0,e)}next(e,t){return this.callbackAttached&&nv(),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(t,this.error):this.wrapSuccess(e,this.result):new nq((n,r)=>{this.nextCallback=t=>{this.wrapSuccess(e,t).next(n,r)},this.catchCallback=e=>{this.wrapFailure(t,e).next(n,r)}})}toPromise(){return new Promise((e,t)=>{this.next(e,t)})}wrapUserFunction(e){try{let t=e();return t instanceof nq?t:nq.resolve(t)}catch(e){return nq.reject(e)}}wrapSuccess(e,t){return e?this.wrapUserFunction(()=>e(t)):nq.resolve(t)}wrapFailure(e,t){return e?this.wrapUserFunction(()=>e(t)):nq.reject(t)}static resolve(e){return new nq((t,n)=>{t(e)})}static reject(e){return new nq((t,n)=>{n(e)})}static waitFor(e){return new nq((t,n)=>{let r=0,i=0,s=!1;e.forEach(e=>{++r,e.next(()=>{++i,s&&i===r&&t()},e=>n(e))}),s=!0,i===r&&t()})}static or(e){let t=nq.resolve(!1);for(let n of e)t=t.next(e=>e?nq.resolve(e):n());return t}static forEach(e,t){let n=[];return e.forEach((e,r)=>{n.push(t.call(this,e,r))}),this.waitFor(n)}static mapArray(e,t){return new nq((n,r)=>{let i=e.length,s=Array(i),o=0;for(let a=0;a<i;a++){let l=a;t(e[l]).next(e=>{s[l]=e,++o===i&&n(s)},e=>r(e))}})}static doWhile(e,t){return new nq((n,r)=>{let i=()=>{!0===e()?t().next(()=>{i()},r):n()};i()})}}function nz(e){return"IndexedDbTransactionError"===e.name}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sl{constructor(){this.ln=new su}addToCollectionParentIndex(e,t){return this.ln.add(t),nq.resolve()}getCollectionParents(e,t){return nq.resolve(this.ln.getEntries(t))}addFieldIndex(e,t){return nq.resolve()}deleteFieldIndex(e,t){return nq.resolve()}deleteAllFieldIndexes(e){return nq.resolve()}createTargetIndexes(e,t){return nq.resolve()}getDocumentsMatchingTarget(e,t){return nq.resolve(null)}getIndexType(e,t){return nq.resolve(0)}getFieldIndexes(e,t){return nq.resolve([])}getNextCollectionGroupToUpdate(e){return nq.resolve(null)}getMinOffset(e,t){return nq.resolve(nB.min())}getMinOffsetFromCollectionGroup(e,t){return nq.resolve(nB.min())}updateCollectionGroup(e,t,n){return nq.resolve()}updateIndexEntries(e,t){return nq.resolve()}}class su{constructor(){this.index={}}add(e){let t=e.lastSegment(),n=e.popLast(),r=this.index[t]||new nZ(nM.comparator),i=!r.has(n);return this.index[t]=r.add(n),i}has(e){let t=e.lastSegment(),n=e.popLast(),r=this.index[t];return r&&r.has(n)}getEntries(e){return(this.index[e]||new nZ(nM.comparator)).toArray()}}new Uint8Array(0);/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sy{constructor(){this.changes=new r2(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,r_.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();let n=this.changes.get(t);return void 0!==n?nq.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class s_{constructor(){this.overlays=new nY(nV.comparator),this.dr=new Map}getOverlay(e,t){return nq.resolve(this.overlays.get(t))}getOverlays(e,t){let n=r4();return nq.forEach(t,t=>this.getOverlay(e,t).next(e=>{null!==e&&n.set(t,e)})).next(()=>n)}saveOverlays(e,t,n){return n.forEach((n,r)=>{this.Tt(e,t,r)}),nq.resolve()}removeOverlaysForBatchId(e,t,n){let r=this.dr.get(n);return void 0!==r&&(r.forEach(e=>this.overlays=this.overlays.remove(e)),this.dr.delete(n)),nq.resolve()}getOverlaysForCollection(e,t,n){let r=r4(),i=t.length+1,s=new nV(t.child("")),o=this.overlays.getIteratorFrom(s);for(;o.hasNext();){let e=o.getNext().value,s=e.getKey();if(!t.isPrefixOf(s.path))break;s.path.length===i&&e.largestBatchId>n&&r.set(e.getKey(),e)}return nq.resolve(r)}getOverlaysForCollectionGroup(e,t,n,r){let i=new nY((e,t)=>e-t),s=this.overlays.getIterator();for(;s.hasNext();){let e=s.getNext().value;if(e.getKey().getCollectionGroup()===t&&e.largestBatchId>n){let t=i.get(e.largestBatchId);null===t&&(t=r4(),i=i.insert(e.largestBatchId,t)),t.set(e.getKey(),e)}}let o=r4(),a=i.getIterator();for(;a.hasNext()&&(a.getNext().value.forEach((e,t)=>o.set(e,t)),!(o.size()>=r)););return nq.resolve(o)}Tt(e,t,n){let r=this.overlays.get(n.key);if(null!==r){let e=this.dr.get(r.largestBatchId).delete(n.key);this.dr.set(r.largestBatchId,e)}this.overlays=this.overlays.insert(n.key,new ix(t,n));let i=this.dr.get(t);void 0===i&&(i=ie(),this.dr.set(t,i)),this.dr.set(t,i.add(n.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sb{constructor(){this.sessionToken=n6.EMPTY_BYTE_STRING}getSessionToken(e){return nq.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,nq.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sC{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.Dr=1,this.vr=new nZ(sT.Ar)}checkEmpty(e){return nq.resolve(0===this.mutationQueue.length)}addMutationBatch(e,t,n,r){let i=this.Dr;this.Dr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];let s=new iN(i,t,n,r);for(let t of(this.mutationQueue.push(s),r))this.vr=this.vr.add(new sT(t.key,i)),this.indexManager.addToCollectionParentIndex(e,t.key.path.popLast());return nq.resolve(s)}lookupMutationBatch(e,t){return nq.resolve(this.Cr(t))}getNextMutationBatchAfterBatchId(e,t){let n=this.Fr(t+1),r=n<0?0:n;return nq.resolve(this.mutationQueue.length>r?this.mutationQueue[r]:null)}getHighestUnacknowledgedBatchId(){return nq.resolve(0===this.mutationQueue.length?-1:this.Dr-1)}getAllMutationBatches(e){return nq.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){let n=new sT(t,0),r=new sT(t,Number.POSITIVE_INFINITY),i=[];return this.vr.forEachInRange([n,r],e=>{let t=this.Cr(e.br);i.push(t)}),nq.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let n=new nZ(nO);return t.forEach(e=>{let t=new sT(e,0),r=new sT(e,Number.POSITIVE_INFINITY);this.vr.forEachInRange([t,r],e=>{n=n.add(e.br)})}),nq.resolve(this.Mr(n))}getAllMutationBatchesAffectingQuery(e,t){let n=t.path,r=n.length+1,i=n;nV.isDocumentKey(i)||(i=i.child(""));let s=new sT(new nV(i),0),o=new nZ(nO);return this.vr.forEachWhile(e=>{let t=e.key.path;return!!n.isPrefixOf(t)&&(t.length===r&&(o=o.add(e.br)),!0)},s),nq.resolve(this.Mr(o))}Mr(e){let t=[];return e.forEach(e=>{let n=this.Cr(e);null!==n&&t.push(n)}),t}removeMutationBatch(e,t){0===this.Or(t.batchId,"removed")||nv(),this.mutationQueue.shift();let n=this.vr;return nq.forEach(t.mutations,r=>{let i=new sT(r.key,t.batchId);return n=n.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,r.key)}).next(()=>{this.vr=n})}Bn(e){}containsKey(e,t){let n=new sT(t,0),r=this.vr.firstAfterOrEqual(n);return nq.resolve(t.isEqual(r&&r.key))}performConsistencyCheck(e){return this.mutationQueue.length,nq.resolve()}Or(e,t){return this.Fr(e)}Fr(e){return 0===this.mutationQueue.length?0:e-this.mutationQueue[0].batchId}Cr(e){let t=this.Fr(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sk{constructor(e){this.persistence=e,this.Lr=new r2(e=>rj(e),r$),this.lastRemoteSnapshotVersion=nP.min(),this.highestTargetId=0,this.kr=0,this.qr=new sI,this.targetCount=0,this.Qr=sf.qn()}forEachTarget(e,t){return this.Lr.forEach((e,n)=>t(n)),nq.resolve()}getLastRemoteSnapshotVersion(e){return nq.resolve(this.lastRemoteSnapshotVersion)}getHighestSequenceNumber(e){return nq.resolve(this.kr)}allocateTargetId(e){return this.highestTargetId=this.Qr.next(),nq.resolve(this.highestTargetId)}setTargetsMetadata(e,t,n){return n&&(this.lastRemoteSnapshotVersion=n),t>this.kr&&(this.kr=t),nq.resolve()}Un(e){this.Lr.set(e.target,e);let t=e.targetId;t>this.highestTargetId&&(this.Qr=new sf(t),this.highestTargetId=t),e.sequenceNumber>this.kr&&(this.kr=e.sequenceNumber)}addTargetData(e,t){return this.Un(t),this.targetCount+=1,nq.resolve()}updateTargetData(e,t){return this.Un(t),nq.resolve()}removeTargetData(e,t){return this.Lr.delete(t.target),this.qr.yr(t.targetId),this.targetCount-=1,nq.resolve()}removeTargets(e,t,n){let r=0,i=[];return this.Lr.forEach((s,o)=>{o.sequenceNumber<=t&&null===n.get(o.targetId)&&(this.Lr.delete(s),i.push(this.removeMatchingKeysForTargetId(e,o.targetId)),r++)}),nq.waitFor(i).next(()=>r)}getTargetCount(e){return nq.resolve(this.targetCount)}getTargetData(e,t){let n=this.Lr.get(t)||null;return nq.resolve(n)}addMatchingKeys(e,t,n){return this.qr.mr(t,n),nq.resolve()}removeMatchingKeys(e,t,n){this.qr.pr(t,n);let r=this.persistence.referenceDelegate,i=[];return r&&t.forEach(t=>{i.push(r.markPotentiallyOrphaned(e,t))}),nq.waitFor(i)}removeMatchingKeysForTargetId(e,t){return this.qr.yr(t),nq.resolve()}getMatchingKeysForTargetId(e,t){let n=this.qr.Sr(t);return nq.resolve(n)}containsKey(e,t){return nq.resolve(this.qr.containsKey(t))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(function(e){let t="";for(let n=0;n<e.length;n++)t.length>0&&(t+="\x01\x01"),t=function(e,t){let n=t,r=e.length;for(let t=0;t<r;t++){let r=e.charAt(t);switch(r){case"\0":n+="\x01\x10";break;case"\x01":n+="\x01\x11";break;default:n+=r}}return n}(e.get(n),t);return t+"\x01\x01"})(e.path),(e,t)=>e.isEqual(t)),this.garbageCollector=new sm(this,t)}static ei(e,t){return new sx(e,t)}Hr(){}Jr(e){return nq.resolve()}forEachTarget(e,t){return this.persistence.getTargetCache().forEachTarget(e,t)}Xn(e){let t=this.nr(e);return this.persistence.getTargetCache().getTargetCount(e).next(e=>t.next(t=>e+t))}nr(e){let t=0;return this.er(e,e=>{t++}).next(()=>t)}er(e,t){return nq.forEach(this.ri,(n,r)=>this.ir(e,n,r).next(e=>e?nq.resolve():t(r)))}removeTargets(e,t,n){return this.persistence.getTargetCache().removeTargets(e,t,n)}removeOrphanedDocuments(e,t){let n=0,r=this.persistence.getRemoteDocumentCache(),i=r.newChangeBuffer();return r.Br(e,r=>this.ir(e,r,t).next(e=>{e||(n++,i.removeEntry(r,nP.min()))})).next(()=>i.apply(e)).next(()=>n)}markPotentiallyOrphaned(e,t){return this.ri.set(t,e.currentSequenceNumber),nq.resolve()}removeTarget(e,t){let n=t.withSequenceNumber(e.currentSequenceNumber);return this.persistence.getTargetCache().updateTargetData(e,n)}addReference(e,t,n){return this.ri.set(n,e.currentSequenceNumber),nq.resolve()}removeReference(e,t,n){return this.ri.set(n,e.currentSequenceNumber),nq.resolve()}updateLimboDocument(e,t){return this.ri.set(t,e.currentSequenceNumber),nq.resolve()}zr(e){let t=e.key.toString().length;return e.isFoundDocument()&&(t+=function e(t){switch(ri(t)){case 0:case 1:return 4;case 2:return 8;case 3:case 8:return 16;case 4:let n=n9(t);return n?16+e(n):16;case 5:return 2*t.stringValue.length;case 6:return n4(t.bytesValue).approximateByteSize();case 7:return t.referenceValue.length;case 9:return(t.arrayValue.values||[]).reduce((t,n)=>t+e(n),0);case 10:case 11:var r;let i;return r=t.mapValue,i=0,nW(r.fields,(t,n)=>{i+=t.length+e(n)}),i;default:throw nv()}}(e.data.value)),t}ir(e,t,n){return nq.or([()=>this.persistence.Yr(e,t),()=>this.persistence.getTargetCache().containsKey(e,t),()=>{let e=this.ri.get(t);return nq.resolve(void 0!==e&&e>n)}])}getCacheSize(e){return this.persistence.getRemoteDocumentCache().getSize(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lj(e){var t;let n=e.auth,r=await e.getIdToken(),i=await lF(e,lx(n,{idToken:r}));lf(null==i?void 0:i.users.length,n,"internal-error");let s=i.users[0];e._notifyReloadListener(s);let o=(null===(t=s.providerUserInfo)||void 0===t?void 0:t.length)?lq(s.providerUserInfo):[],a=[...e.providerData.filter(e=>!o.some(t=>t.providerId===e.providerId)),...o],l=e.isAnonymous,u=!(e.email&&s.passwordHash)&&!(null==a?void 0:a.length);Object.assign(e,{uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new lB(s.createdAt,s.lastLoginAt),isAnonymous:!!l&&u})}async function l$(e){let t=eF(e);await lj(t),await t.auth._persistUserIfCurrent(t),t.auth._notifyListenersIfCurrent(t)}function lq(e){return e.map(e=>{var{providerId:t}=e,n=ln(e,["providerId"]);return{providerId:t,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uH(e,t,n=!1){if(th(e.app))return Promise.reject(lh(e));let r="signIn",i=await u$(e,r,t),s=await uV._fromIdTokenResponse(e,r,i);return n||await e._updateCurrentUser(s.user),s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cE{constructor(e){this.apiKey=e}getGenerativeModel(e,t){if(!e.model)throw new hZ("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new cw(this.apiKey,e,t)}getGenerativeModelFromCachedContent(e,t,n){if(!e.name)throw new h2("Cached content must contain a `name` field.");if(!e.model)throw new h2("Cached content must contain a `model` field.");for(let n of["model","systemInstruction"])if((null==t?void 0:t[n])&&e[n]&&(null==t?void 0:t[n])!==e[n]){if("model"===n&&(t.model.startsWith("models/")?t.model.replace("models/",""):t.model)===(e.model.startsWith("models/")?e.model.replace("models/",""):e.model))continue;throw new h2(`Different value for "${n}" specified in modelParams (${t[n]}) and cachedContent (${e[n]})`)}let r=Object.assign(Object.assign({},t),{model:e.model,tools:e.tools,toolConfig:e.toolConfig,systemInstruction:e.systemInstruction,cachedContent:e});return new cw(this.apiKey,r,n)}}function c_(e,t){let n={};for(let r in e)e.hasOwnProperty(r)&&(n[r]=t(e[r]));return n}function cb(e){if(null==e)return null;if(e instanceof Number&&(e=e.valueOf()),"number"==typeof e&&isFinite(e)||!0===e||!1===e||"[object String]"===Object.prototype.toString.call(e))return e;if(e instanceof Date)return e.toISOString();if(Array.isArray(e))return e.map(e=>cb(e));if("function"==typeof e||"object"==typeof e)return c_(e,e=>cb(e));throw Error("Data cannot be encoded in JSON: "+e)}function cI(e){if(null==e)return e;if(e["@type"])switch(e["@type"]){case"type.googleapis.com/google.protobuf.Int64Value":case"type.googleapis.com/google.protobuf.UInt64Value":{let t=Number(e.value);if(isNaN(t))throw Error("Data cannot be decoded from JSON: "+e);return t}default:throw Error("Data cannot be decoded from JSON: "+e)}return Array.isArray(e)?e.map(e=>cI(e)):"function"==typeof e||"object"==typeof e?c_(e,e=>cI(e)):e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cT="functions",cC={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class cS extends ek{constructor(e,t,n){super(`${cT}/${e}`,t||""),this.details=n,Object.setPrototypeOf(this,cS.prototype)}}function cA(e,t){let n,r=function(e){if(e>=200&&e<300)return"ok";switch(e){case 0:case 500:return"internal";case 400:return"invalid-argument";case 401:return"unauthenticated";case 403:return"permission-denied";case 404:return"not-found";case 409:return"aborted";case 429:return"resource-exhausted";case 499:return"cancelled";case 501:return"unimplemented";case 503:return"unavailable";case 504:return"deadline-exceeded"}return"unknown"}(e),i=r;try{let e=t&&t.error;if(e){let t=e.status;if("string"==typeof t){if(!cC[t])return new cS("internal","internal");r=cC[t],i=t}let s=e.message;"string"==typeof s&&(i=s),n=e.details,void 0!==n&&(n=cI(n))}}catch(e){}return"ok"===r?null:new cS(r,i,n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ck{constructor(e,t,n){this.auth=null,this.messaging=null,this.appCheck=null,this.auth=e.getImmediate({optional:!0}),this.messaging=t.getImmediate({optional:!0}),this.auth||e.get().then(e=>this.auth=e,()=>{}),this.messaging||t.get().then(e=>this.messaging=e,()=>{}),this.appCheck||n.get().then(e=>this.appCheck=e,()=>{})}async getAuthToken(){if(this.auth)try{let e=await this.auth.getToken();return null==e?void 0:e.accessToken}catch(e){return}}async getMessagingToken(){if(this.messaging&&"Notification"in self&&"granted"===Notification.permission)try{return await this.messaging.getToken()}catch(e){return}}async getAppCheckToken(e){if(this.appCheck){let t=e?await this.appCheck.getLimitedUseToken():await this.appCheck.getToken();return t.error?null:t.token}return null}async getContext(e){return{authToken:await this.getAuthToken(),messagingToken:await this.getMessagingToken(),appCheckToken:await this.getAppCheckToken(e)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cR="us-central1",cN=/^data: (.*?)(?:\n|$)/;class cO{constructor(e,t,n,r,i=cR,s=(...e)=>fetch(...e)){this.app=e,this.fetchImpl=s,this.emulatorOrigin=null,this.contextProvider=new ck(t,n,r),this.cancelAllRequests=new Promise(e=>{this.deleteService=()=>Promise.resolve(e())});try{let e=new URL(i);this.customDomain=e.origin+("/"===e.pathname?"":e.pathname),this.region=cR}catch(e){this.customDomain=null,this.region=i}}_delete(){return this.deleteService()}_url(e){let t=this.app.options.projectId;if(null!==this.emulatorOrigin){let n=this.emulatorOrigin;return`${n}/${t}/${this.region}/${e}`}return null!==this.customDomain?`${this.customDomain}/${e}`:`https://${this.region}-${t}.cloudfunctions.net/${e}`}}async function cx(e,t,n,r){let i;n["Content-Type"]="application/json";try{i=await r(e,{method:"POST",body:JSON.stringify(t),headers:n})}catch(e){return{status:0,json:null}}let s=null;try{s=await i.json()}catch(e){}return{status:i.status,json:s}}async function cD(e,t){let n={},r=await e.contextProvider.getContext(t.limitedUseAppCheckTokens);return r.authToken&&(n.Authorization="Bearer "+r.authToken),r.messagingToken&&(n["Firebase-Instance-ID-Token"]=r.messagingToken),null!==r.appCheckToken&&(n["X-Firebase-AppCheck"]=r.appCheckToken),n}async function cP(e,t,n,r){var i;let s;let o={data:n=cb(n)},a=await cD(e,r),l=(i=r.timeout||7e4,s=null,{promise:new Promise((e,t)=>{s=setTimeout(()=>{t(new cS("deadline-exceeded","deadline-exceeded"))},i)}),cancel:()=>{s&&clearTimeout(s)}}),u=await Promise.race([cx(t,o,a,e.fetchImpl),l.promise,e.cancelAllRequests]);if(l.cancel(),!u)throw new cS("cancelled","Firebase Functions instance was deleted.");let h=cA(u.status,u.json);if(h)throw h;if(!u.json)throw new cS("internal","Response is not valid JSON object.");let c=u.json.data;if(void 0===c&&(c=u.json.result),void 0===c)throw new cS("internal","Response is missing data field.");return{data:cI(c)}}async function cL(e,t,n,r){var i;let s,o,a;let l={data:n=cb(n)},u=await cD(e,r);u["Content-Type"]="application/json",u.Accept="text/event-stream";try{s=await e.fetchImpl(t,{method:"POST",body:JSON.stringify(l),headers:u,signal:null==r?void 0:r.signal})}catch(t){if(t instanceof Error&&"AbortError"===t.name){let e=new cS("cancelled","Request was cancelled.");return{data:Promise.reject(e),stream:{[Symbol.asyncIterator]:()=>({next:()=>Promise.reject(e)})}}}let e=cA(0,null);return{data:Promise.reject(e),stream:{[Symbol.asyncIterator]:()=>({next:()=>Promise.reject(e)})}}}let h=new Promise((e,t)=>{o=e,a=t});null===(i=null==r?void 0:r.signal)||void 0===i||i.addEventListener("abort",()=>{let e=new cS("cancelled","Request was cancelled.");a(e)});let c=function(e,t,n,r){let i=(e,r)=>{let i=e.match(cN);if(!i)return;let s=i[1];try{let e=JSON.parse(s);if("result"in e){t(cI(e.result));return}if("message"in e){r.enqueue(cI(e.message));return}if("error"in e){let t=cA(0,e);r.error(t),n(t);return}}catch(e){if(e instanceof cS){r.error(e),n(e);return}}},s=new TextDecoder;return new ReadableStream({start(t){let o="";return a();async function a(){if(null==r?void 0:r.aborted){let e=new cS("cancelled","Request was cancelled");return t.error(e),n(e),Promise.resolve()}try{let{value:l,done:u}=await e.read();if(u){o.trim()&&i(o.trim(),t),t.close();return}if(null==r?void 0:r.aborted){let r=new cS("cancelled","Request was cancelled");t.error(r),n(r),await e.cancel();return}let h=(o+=s.decode(l,{stream:!0})).split("\n");for(let e of(o=h.pop()||"",h))e.trim()&&i(e.trim(),t);return a()}catch(r){let e=r instanceof cS?r:cA(0,null);t.error(e),n(e)}}},cancel:()=>e.cancel()})}(s.body.getReader(),o,a,null==r?void 0:r.signal);return{stream:{[Symbol.asyncIterator](){let e=c.getReader();return{async next(){let{value:t,done:n}=await e.read();return{value:t,done:n}},return:async()=>(await e.cancel(),{done:!0,value:void 0})}}},data:h}}const cM="@firebase/functions",cU="0.12.1";tl(new eV(cT,(e,{instanceIdentifier:t})=>{let n=e.getProvider("app").getImmediate();return new cO(n,e.getProvider("auth-internal"),e.getProvider("messaging-internal"),e.getProvider("app-check-internal"),t)},"PUBLIC").setMultipleInstances(!0)),tm(cM,cU,void 0),tm(cM,cU,"esm2017");const cF=document.getElementById("habitInput"),cV=document.getElementById("addHabitBtn"),cB=document.getElementById("habitList"),cj=document.getElementById("send-btn"),c$=document.getElementById("chat-input"),cq=document.getElementById("chat-history");let cz=!1;const cH=document.getElementById("signOutBtn"),cG=JSON.parse(localStorage.getItem("email")),cK=function(e=tg(),t=cR){let n=tu(eF(e),cT).getImmediate({identifier:t}),r=eI("functions");return r&&function(e,t,n){eF(e).emulatorOrigin=`http://${t}:${n}`}(n,...r),n}();async function cW(){let e=JSON.parse(sessionStorage.getItem("authenticatedUser"));if(!e)return alert("Biometric authentication required."),!1;try{var t;let n=(t="verifyBiometric",function(e,t,n){let r=r=>(function(e,t,n,r){let i=e._url(t);return cP(e,i,n,r)})(e,t,r,n||{});return r.stream=(n,r)=>(function(e,t,n,r){let i=e._url(t);return cL(e,i,n,r||{})})(e,t,n,r),r}(eF(cK),t,void 0));return(await n({userEmail:cG,credentialId:e.id})).data.success}catch(e){return console.error("Biometric verification failed:",e),alert("Biometric authentication failed."),!1}}async function cQ(){n=new cE((await function(e){e=am(e,aE);let t=am(e.firestore,aC);return(function(e,t,n={}){let r=new n_;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ar({next:a=>{s.eu(),t.enqueueAndForget(()=>oO(e,o));let l=a.docs.has(n);!l&&a.fromCache?i.reject(new nE(nw.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&a.fromCache&&r&&"server"===r.source?i.reject(new nE(nw.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(a)},error:e=>i.reject(e)}),o=new oL(new rz(n.path),s,{includeMetadataChanges:!0,ua:!0});return oN(e,o)})(await au(e),e.asyncQueue,t,n,r)),r.promise})(aS(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new le(e);return new a4(e,i,t._key,r,new a8(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}(aI(hJ,"apikey","googlegenai"))).data().key).getGenerativeModel({model:"gemini-1.5-flash"})}function cY(e){cz||(cq.innerHTML="",cz=!0);let t=document.createElement("div");t.textContent=e,t.className="history",cq.appendChild(t),cq.scrollTop=cq.scrollHeight,c$.value=""}async function cJ(e){if(!await cW())return;let t=await cZ(e);cF.value="",c2(t,e)}async function cX(){if(!await cW())return;let e=await c0();cB.innerHTML="";let t=[];e.forEach(e=>{t.push({id:e.id,text:e.data().text,completed:e.data().completed})}),t.sort((e,t)=>new Date(t.timeCreated)-new Date(e.timeCreated)),t.forEach(e=>{c2(e.id,e.text,e.completed)})}async function cZ(e){if(!JSON.parse(sessionStorage.getItem("authenticatedUser"))){alert("Biometric authentication required.");return}return(await function(e,t){var n;let r=am(e.firestore,aC),i=aI(e),s=(n=e.converter)?n.toFirestore(t):t;return lt(r,[(function(e,t,n,r,i,s={}){let o,a;let l=e.$u(s.merge||s.mergeFields?2:0,t,n,i);aq("Data must be an object, but it was:",l,r);let u=aj(r,l);if(s.merge)o=new n1(l.fieldMask),a=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=az(t,r,n);if(!l.contains(i))throw new nE(nw.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);aW(e,i)||e.push(i)}o=new n1(e),a=l.fieldTransforms.filter(e=>o.covers(e.field))}else o=null,a=l.fieldTransforms;return new aD(new rE(u),o,a)})(aF(e.firestore),"addDoc",i._key,s,null!==e.converter,{}).toMutation(i._key,iy.exists(!1))]).then(()=>i)}(ab(hJ,"habits"),{text:e,email:cG,completed:!1,authenticated:!0})).id}async function c0(){let e=function(e,t,...n){let r=[];for(let i of(t instanceof aX&&r.push(t),function(e){let t=e.filter(e=>e instanceof a1).length,n=e.filter(e=>e instanceof a0).length;if(t>1||t>0&&n>0)throw new nE(nw.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r=r.concat(n)),r))e=i._apply(e);return e}(ab(hJ,"habits"),function(e,t,n){let r=aJ("where",e);return a0._create(r,"==",n)}("email",0,cG));return await function(e){e=am(e,aw);let t=am(e.firestore,aC),n=aS(t),r=new le(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new nE(nw.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new n_;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ar({next:n=>{s.eu(),t.enqueueAndForget(()=>oO(e,o)),n.fromCache&&"server"===r.source?i.reject(new nE(nw.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),o=new oL(n,s,{includeMetadataChanges:!0,ua:!0});return oN(e,o)})(await au(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new a9(t,r,e,n)))}(e)}async function c1(e){var t;await lt(am((t=aI(hJ,"habits",e)).firestore,aC),[new ik(t._key,iy.none())])}function c2(e,t,n=!1){let r=document.createElement("li");r.id=e,r.classList.add("habit-item");let i=document.createElement("span");i.textContent=t,i.className=n?"completed":"habit-text";let s=document.createElement("div");s.classList.add("habit-buttons");let o=document.createElement("button");o.textContent=n?"Mark as Incomplete":"Mark as Complete",o.className="complete-btn",o.addEventListener("click",async()=>{n?window.confirm("Are you sure you want to mark this habit as incomplete?")&&(await c6(e,!n),cX()):window.confirm("Are you sure you want to mark this habit as complete?")&&(await c6(e,!n),cX())});let a=document.createElement("button");a.textContent="Delete Habit",a.className="delete-btn",a.addEventListener("click",async()=>{window.confirm("Are you sure you want to delete this habit?")&&(await c1(e),cX())}),s.appendChild(o),s.appendChild(a),r.appendChild(i),r.appendChild(s),cB.appendChild(r)}async function c6(e,t){await function(e,t,n,...r){e=am(e,aE);let i=am(e.firestore,aC),s=aF(i);return lt(i,[("string"==typeof(t=eF(t))||t instanceof ak?function(e,t,n,r,i,s){let o=e.$u(1,t,n),a=[az(t,r,n)],l=[i];if(s.length%2!=0)throw new nE(nw.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)a.push(az(t,s[e])),l.push(s[e+1]);let u=[],h=rE.empty();for(let e=a.length-1;e>=0;--e)if(!aW(u,a[e])){let t=a[e],n=l[e];n=eF(n);let r=o.Lu(t);if(n instanceof aV)u.push(t);else{let e=aB(n,r);null!=e&&(u.push(t),h.set(t,e))}}return new aP(h,new n1(u),o.fieldTransforms)}(s,"updateDoc",e._key,t,void 0,r):function(e,t,n,r){let i=e.$u(1,t,n);aq("Data must be an object, but it was:",i,r);let s=[],o=rE.empty();return nW(r,(e,r)=>{let a=aG(t,e,n);r=eF(r);let l=i.Lu(a);if(r instanceof aV)s.push(a);else{let e=aB(r,l);null!=e&&(s.push(a),o.set(a,e))}}),new aP(o,new n1(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,iy.exists(!0))])}(aI(hJ,"habits",e),{completed:t})}async function c3(e){cY((await n.generateContent(e)).response.text())}cG||(window.location.href="index.html"),window.addEventListener("load",async()=>{cQ(),cX()}),cj.addEventListener("click",async()=>{let e=c$.value.trim().toLowerCase();e?(e.includes("add")?cY('To add a new habit, enter a description into the text input under the "Add a New Habit" section, and then click on the "Add Habit" button.'):e.includes("delete")?cY('To delete a habit, click on its corresponding "Delete Habit" button under the "Your Habits" section.'):e.includes("modify")?cY('To modify the status of a habit, click on its corresponding "Mark as Complete/Incomplete" button under the "Your Habits" section.'):cY("Please specify if you would like to add, delete, or modify the status of a habit."),0):cY("Please enter a prompt.")}),c$.addEventListener("keypress",function(e){"Enter"===e.key&&cj.click()}),cV.addEventListener("click",async()=>{let e=cF.value.trim();e?await cJ(e):alert("Please enter a habit.")}),cF.addEventListener("keypress",function(e){"Enter"===e.key&&cV.click()}),window.addEventListener("error",function(e){console.error("Error occurred: ",e.message)}),cH.addEventListener("click",function(e){localStorage.removeItem("email"),window.location.href="index.html"});
//# sourceMappingURL=habits.8a9d2c00.js.map
